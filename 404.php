  ...
  <section class="relative min-h-[80vh] flex items-center justify-center overflow-hidden circuit-bg error-scanline">
    ...
    <div class="relative z-10 text-center px-6 max-w-2xl mx-auto">
      ...
      <div class="grid grid-cols-2 sm:grid-cols-3 gap-3 max-w-lg mx-auto">
        <a href="<?= url('/services') ?>" class="error-nav-card glass-panel rounded-2xl p-4 text-center border border-white/5">
        ...
        <a href="<?= url('/solutions') ?>" class="error-nav-card glass-panel rounded-2xl p-4 text-center border border-white/5">
        ...
        <a href="<?= url('/blog') ?>" class="error-nav-card glass-panel rounded-2xl p-4 text-center border border-white/5">
        ...
        <a href="<?= url('/about') ?>" class="error-nav-card glass-panel rounded-2xl p-4 text-center border border-white/5">
        ...
        <a href="<?= url('/contact') ?>" class="error-nav-card glass-panel rounded-2xl p-4 text-center border border-white/5">
        ...
        <a href="<?= url('/') ?>" class="error-nav-card glass-panel rounded-2xl p-4 text-center border border-white/5">
