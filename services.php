    ...
    <div class="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
      ...
      <div class="lg:col-span-7 space-y-8">
        ...
        <div class="reveal reveal-delay-4 flex flex-wrap gap-4 pt-2">
          ...
          <a href="contact.php" class="inline-flex items-center gap-2 bg-white/5 border border-white/10 text-white px-8 py-4 rounded-2xl font-bold text-base hover:bg-white/10 hover:border-white/20 transition-all">
        ...
        <div class="srv-card-wrap <?= $colSpanClass ?>">
          ...
          >
            ...
            <div class="relative z-10">
              ...
              <!-- CTA link -->
              <a href="service-detail.php?slug=<?= e($service['slug']) ?>"
    ...
    <div class="relative rounded-[3rem] overflow-hidden border border-white/5 shadow-2xl">
      ...
      <div class="relative z-10 p-12 md:p-20 text-center">
        ...
        <div class="reveal flex flex-col sm:flex-row justify-center gap-5">
          <a href="contact.php" class="inline-flex items-center justify-center gap-2 tech-gradient text-on-primary-fixed px-10 py-4.5 rounded-2xl font-bold text-lg hover:shadow-[0_0_50px_rgba(0,242,255,0.35)] transition-all active:scale-[0.97]">
