...
?>
  ...
  <section class="relative py-12 md:py-20 px-4 md:px-8 overflow-hidden hero-mesh">
    ...
    <div class="relative z-10 max-w-4xl mx-auto">
      ...
      <nav class="flex items-center gap-2 text-sm text-on-surface-variant mb-10 reveal" aria-label="مسار التنقل">
        <a href="<?= url('/') ?>" class="text-primary-container hover:text-white transition-colors">الرئيسية</a>
        <span class="material-symbols-outlined text-base" aria-hidden="true">chevron_left</span>
        <a href="<?= url('/blog') ?>" class="text-primary-container hover:text-white transition-colors">المدونة</a>
        <span class="material-symbols-outlined text-base" aria-hidden="true">chevron_left</span>
  ...
  <section class="pb-24 px-4 md:px-8">
    <div class="max-w-4xl mx-auto flex items-center justify-between">
      <a href="<?= url('/blog') ?>" class="inline-flex items-center gap-2 text-sm font-bold transition-all hover:gap-3 group" style="color: <?= $colorHex ?>;">
