...
<style>
  ...
  <section class="py-10 md:py-16">
    <div class="max-w-7xl mx-auto">
      ...
      <a href="blog-detail.php?slug=<?= urlencode($featured['slug']) ?>" class="block featured-cinematic group reveal">
  ...
  <section class="py-12 md:py-16 section-glow">
    <div class="max-w-7xl mx-auto">
      ...
      <div class="text-center py-28">
        ...
        <a href="blog.php" class="inline-flex items-center gap-2 text-primary-container text-sm font-bold hover:gap-3 transition-all bg-primary-container/8 border border-primary-container/15 px-6 py-3 rounded-xl">
      ...
      <div class="space-y-8">
        ...
        foreach ($posts as $i => $post):
          ...
          if ($i === 0):
        ?>
        <a href="blog-detail.php?slug=<?= urlencode($post['slug']) ?>" class="block blog-card-horizontal group reveal">
        ...
        <article class="blog-card-v2 <?= $isGold ? 'gold-accent' : '' ?> reveal group">
          <a href="blog-detail.php?slug=<?= urlencode($post['slug']) ?>" class="flex flex-col h-full">
            <!-- Image area -->
      ...
      <div class="relative overflow-hidden rounded-[2.5rem] circuit-bg p-8 md:p-14 lg:p-16 text-center border border-primary-container/15 reveal">
        ...
        <div class="relative z-10">
          ...
          <div class="flex flex-col sm:flex-row gap-4 justify-center">
            <a href="contact.php" class="cta-btn tech-gradient text-on-primary-fixed px-8 py-4 rounded-xl font-bold text-lg inline-flex items-center justify-center gap-2">
              <span class="material-symbols-outlined text-xl" aria-hidden="true">chat</span>
              تواصل مع فريقنا
            </a>
            <a href="contact.php" class="bg-white/5 border border-white/10 text-white px-8 py-4 rounded-xl font-bold text-lg hover:bg-white/10 hover:border-white/15 transition-all duration-300 inline-flex items-center justify-center gap-2">
