  ...
  <div class="max-w-screen-2xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
    ...
    <div class="reveal-right space-y-8 text-right order-1">
      ...
      <p class="text-on-surface-variant leading-relaxed text-lg">
        ركال مؤسسة تقنية وطنية سعودية تأسست في الرياض، وتعمل على تمكين الجهات الحكومية والقطاع الخاص من الانطلاق نحو التحول الرقمي الشامل. نجمع بين عمق الفهم للبيئة المحلية ومرونة الأدوات التقنية العالمية.
      </p>
      <p class="text-on-surface-variant leading-relaxed text-lg">
        منذ تأسيسنا، قدّمنا حلولاً برمجية متكاملة لمئات المنشآت في مختلف القطاعات — من الجهات الحكومية والمنشآت الصحية إلى التعليم والتجارة — مما جعل ركال اسماً راسخاً في صناعة التقنية السعودية.
      </p>
      <p class="text-on-surface-variant leading-relaxed text-lg">
        نؤمن بأن التحول الرقمي الحقيقي يبدأ من فهم عميق للاحتياج المحلي. لذلك التزامنا بمبادئ رؤية المملكة ٢٠٣٠ جعلنا نوطّن التقنية ونبني كفاءات وطنية تخدم مستقبل المملكة.
      </p>
    </div>
  ...
  <div class="max-w-screen-2xl mx-auto">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
      ...
      <div class="glass-panel card-hover reveal p-10 rounded-[2rem] text-right space-y-6 hover:border-primary-container/40 transition-all duration-500">
        ...
        <div>
          <h3 class="text-2xl font-bold text-white mb-3">رؤيتنا ٢٠٣٠</h3>
          <div class="h-0.5 w-16 bg-primary-container/50 rounded-full mb-5"></div>
        </div>
        <p class="text-on-surface-variant leading-relaxed text-lg">
          أن نكون الشريك التقني الأول والأكثر ثقةً للمؤسسات الوطنية، نقود التحول الرقمي في المملكة العربية السعودية لتحقيق أهداف رؤية ٢٠٣٠ بأدوات وطنية وكفاءات سعودية متميزة.
        </p>
      </div>
      <!-- Mission Card -->
      <div class="glass-panel card-hover reveal p-10 rounded-[2rem] text-right space-y-6 hover:border-sand-gold/40 transition-all duration-500">
        ...
        <div>
          ...
          <div class="h-0.5 w-16 bg-sand-gold/50 rounded-full mb-5"></div>
        </div>
        <p class="text-on-surface-variant leading-relaxed text-lg">
          تمكين المؤسسات الحكومية والخاصة بحلول تقنية ذكية آمنة وفعّالة، تُعزّز كفاءتها التشغيلية وترفع جودة خدماتها، مع الالتزام الكامل بمعايير السيادة الرقمية والأمن السيبراني الوطني.
        </p>
      </div>
    </div>
  </div>
  ...
  <div class="max-w-screen-2xl mx-auto relative z-10">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
      ...
      <div class="bg-surface-container card-hover reveal rounded-[2rem] p-8 text-right space-y-5 border border-transparent hover:border-primary-container/30 transition-all duration-300 hover:translate-y-[-4px]">
        ...
        <h3 class="text-xl font-bold text-white">النزاهة والشفافية</h3>
      ...
      <div class="bg-surface-container card-hover reveal rounded-[2rem] p-8 text-right space-y-5 border border-transparent hover:border-sand-gold/30 transition-all duration-300 hover:translate-y-[-4px]">
        ...
        <h3 class="text-xl font-bold text-white">الابتكار المسؤول</h3>
      ...
      <div class="bg-surface-container card-hover reveal rounded-[2rem] p-8 text-right space-y-5 border border-transparent hover:border-primary-container/30 transition-all duration-300 hover:translate-y-[-4px]">
        ...
        <h3 class="text-xl font-bold text-white">التميز التقني</h3>
      ...
      <div class="bg-surface-container card-hover reveal rounded-[2rem] p-8 text-right space-y-5 border border-transparent hover:border-sand-gold/30 transition-all duration-300 hover:translate-y-[-4px]">
        ...
        <h3 class="text-xl font-bold text-white">السيادة الرقمية</h3>
        <p class="text-on-surface-variant text-sm leading-relaxed">نؤمن بحق المملكة في امتلاك بنيتها التقنية وبياناتها، ونعمل على تحقيق ذلك في كل مشروع.</p>
      </div>
    </div>
  </div>
</section>
  ...
  <div class="max-w-screen-2xl mx-auto">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
      ...
      <div class="glass-panel card-hover reveal p-8 rounded-[2rem] text-right space-y-5 hover:border-primary-container/40 transition-all duration-500 hover:translate-y-[-4px]">
        ...
        <h3 class="text-xl font-bold text-white">خبرة محلية عميقة</h3>
      ...
      <div class="glass-panel card-hover reveal p-8 rounded-[2rem] text-right space-y-5 hover:border-sand-gold/40 transition-all duration-500 hover:translate-y-[-4px]">
        ...
        <h3 class="text-xl font-bold text-white">كفاءات وطنية</h3>
      ...
      <div class="glass-panel card-hover reveal p-8 rounded-[2rem] text-right space-y-5 hover:border-primary-container/40 transition-all duration-500 hover:translate-y-[-4px]">
        ...
        <h3 class="text-xl font-bold text-white">سيادة البيانات</h3>
      ...
      <div class="glass-panel card-hover reveal p-8 rounded-[2rem] text-right space-y-5 hover:border-sand-gold/40 transition-all duration-500 hover:translate-y-[-4px]">
        ...
        <h3 class="text-xl font-bold text-white">دعم متواصل</h3>
        <p class="text-on-surface-variant text-sm leading-relaxed">فريق دعم فني متواجد بجانبك في كل خطوة، يضمن استمرارية عملك ويحل أي تحدي تقني بسرعة.</p>
      </div>
    </div>
  </div>
</section>
