  ...
  <div class="max-w-screen-2xl mx-auto w-full grid md:grid-cols-2 gap-12 items-center relative z-10">
    <div class="text-right space-y-8">
      ...
      <div class="flex flex-wrap gap-4 pt-4 reveal reveal-delay-4">
        <a href="<?= url('/contact') ?>" class="cta-btn tech-gradient text-on-primary-fixed px-8 py-4 rounded-xl font-bold text-lg flex items-center gap-2 shadow-[0_10px_30px_rgba(0,242,255,0.2)]">
          ابدأ مشروعك
    ...
    <div class="relative group hidden md:block">
      ...
      <div class="relative glass-panel p-4 rounded-[2.5rem] border-white/5 shadow-2xl overflow-hidden">
        <div class="hero-visual w-full h-[300px] md:h-[550px] rounded-[2rem] opacity-80 group-hover:opacity-100 transition-all duration-700 relative overflow-hidden">
          <img src="images/hero-tech.jpg" alt="حلول رقمية متقدمة - ركال" class="absolute inset-0 w-full h-full object-cover" loading="eager" />
          <div class="absolute inset-0 bg-gradient-to-br from-surface/60 via-surface/30 to-transparent"></div>
          <div class="absolute inset-0 bg-gradient-to-t from-surface/50 via-transparent to-transparent"></div>
        </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
      <div class="md:col-span-2 glass-panel card-hover reveal p-10 rounded-[2rem] hover:border-primary-container/40 transition-all duration-500 group overflow-hidden relative">
        <div class="relative z-10">
          ...
          <a href="<?= url('/services') ?>" class="text-primary-container flex items-center gap-2 group-hover:gap-4 transition-all font-bold">
            استكشف المزيد
            <span class="material-symbols-outlined" aria-hidden="true">arrow_back</span>
          </a>
        </div>
  ...
  <div class="max-w-screen-2xl mx-auto flex flex-col lg:flex-row gap-16 items-center relative z-10">
    <div class="w-full lg:w-1/2 relative order-2 lg:order-1 reveal-left">
      ...
      <div class="rounded-[3rem] shadow-2xl border-4 border-white/5 w-full h-[350px] md:h-[600px] relative overflow-hidden bg-surface-container">
        <img src="images/riyadh-office.jpg" alt="بيئة عمل تقنية حديثة في الرياض" class="absolute inset-0 w-full h-full object-cover" loading="lazy" />
        ...
        <div class="absolute bottom-8 right-8 left-8">
          <div class="glass-panel rounded-2xl px-5 py-3 inline-flex items-center gap-3">
            <span class="material-symbols-outlined text-primary-container" aria-hidden="true">location_on</span>
            <div>
              <div class="text-white text-sm font-bold">الرياض، المملكة العربية السعودية</div>
              <div class="text-on-surface-variant text-xs">بيئة عمل تقنية حديثة</div>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="relative rounded-[3rem] bg-gradient-to-br from-surface-container-high to-surface-dim p-12 md:p-24 overflow-hidden border border-white/5 shadow-2xl reveal-scale">
      ...
      <div class="relative z-10 text-center max-w-3xl mx-auto">
        ...
        <div class="flex flex-col md:flex-row justify-center gap-6">
          <a href="<?= url('/contact') ?>" class="tech-gradient text-on-primary-fixed px-12 py-5 rounded-2xl font-bold text-lg hover:shadow-[0_0_50px_rgba(0,242,255,0.4)] transition-all active:scale-95">تحدث معنا الآن</a>
